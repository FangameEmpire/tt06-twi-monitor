...
module I2C_Start_Stop_Detector_Testbench();
	// Ports
	logic clk, reset;
	logic SDA, SCL;
	...
	// SDA and SCL should be oversampled by at least 2x so that start/stop are detected before addr/data begin.
	localparam ov = 3;
...
endmodule // I2C_Start_Stop_Detector_Testbench
